const BGM = [
  ...
  { track: "Demon Battle", name: "Black As Sin", source: " Red As Blood,Wild Arms 3" },
  ...
  { track: "Forest", name: "The Deep Forest", source: " the Lost Forest,Suikoden V" },
  ...
  { track: "Grunthall", name: "The Sky", source: " the Clouds, and You,Xenogears" },
  ...
  { track: "Sadness", name: "On That Day", source: " Five Years Ago,Final Fantasy VII" },
  ...
  { track: "Tears", name: "Tears of the Stars", source: " Hearts of the People,Xenogears" },
